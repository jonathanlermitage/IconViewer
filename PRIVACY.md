...
Icon Viewer 2 plugin does NOT collect or store any personal data. All settings are stored locally, at IDE level and optionally at project level.
...
| `pluginID`          | The ID of the plugin reporting the data.           | `lermitage.intellij.iconviewer`<br>*This value never changes*                                      |
| `pluginLicenseType` | The license type of the plugin reporting the data. | `free`<br>*This value never changes*                                                               |
| `pluginVersion`     | The version of the plugin reporting the data.      | `1.32.2`, `1.32.1`                                                                                 |
